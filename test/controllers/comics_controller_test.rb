...
class ComicsControllerTest < ActionController::TestCase
  ...
  test "should create comic" do
    assert_difference('Comic.count') do
      post :create, comic: { Autor: @comic.Autor, Editorial: @comic.Editorial, Fecha_de_lanzamiento: @comic.Fecha_de_lanzamiento, Idioma: @comic.Idioma, Nombre: @comic.Nombre, Portada: @comic.Portada }
    end
  ...
  test "should update comic" do
    patch :update, id: @comic, comic: { Autor: @comic.Autor, Editorial: @comic.Editorial, Fecha_de_lanzamiento: @comic.Fecha_de_lanzamiento, Idioma: @comic.Idioma, Nombre: @comic.Nombre, Portada: @comic.Portada }
    assert_redirected_to comic_path(assigns(:comic))
  end
